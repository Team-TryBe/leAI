...
import { GraduationCap, Briefcase, Users, Plus, Trash2, FileText, Save, Eye } from 'lucide-react'
      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-display font-bold text-brand-text">Master CV</h1>
            <p className="text-brand-text-muted">
              Your data is automatically saved. Fill once, update anytime.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="inline-flex items-center gap-2 px-6 py-2 rounded-lg bg-brand-primary text-white font-semibold hover:opacity-90 transition disabled:opacity-60"
            >
              <Save size={18} /> {isSaving ? 'Saving...' : 'Save All'}
            </button>
            <button
              onClick={() => router.push('/dashboard/master-cv/preview')}
              className="inline-flex items-center gap-2 px-6 py-2 rounded-lg bg-brand-accent/20 text-brand-accent font-semibold hover:bg-brand-accent/30 transition"
            >
              <Eye size={18} /> Preview JSON
            </button>
            <button
              onClick={() => router.push('/dashboard/master-cv/view')}
              className="inline-flex items-center gap-2 px-6 py-2 rounded-lg bg-brand-dark-border text-brand-text font-semibold hover:bg-brand-dark-border/80 transition"
            >
          ...
          {saveMessage && (
            <div
              className={`rounded-lg px-4 py-3 text-sm font-medium space-y-2 ${
        ...
        <div className="card-dark p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-2">
              <label className="text-brand-text-muted text-sm mb-2 block">Phone Number</label>
              <input
                className="rounded-lg bg-brand-dark text-brand-text p-3 w-full"
          ...
          <div className="border-t border-brand-dark-border pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                className="rounded-lg bg-brand-dark text-brand-text p-3 text-sm"

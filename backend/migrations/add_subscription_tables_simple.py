...
Run with: python3 migrations/add_subscription_tables_simple.py
"""
...
-- Insert default plans (on conflict, do nothing)
...
def run_migration():
    ...
    database_url = os.getenv('DATABASE_URL', 'postgresql://postgres:postgres@localhost:5432/aditus')
    
    print("🔄 Running subscription tables migration...")
    ...
    try:
        ...
        print("❌ Error: psql not found. Please ensure PostgreSQL is installed and in PATH")
        print("\nAlternatively, you can run this SQL manually:")
        print(SQL_COMMANDS)
        return False
